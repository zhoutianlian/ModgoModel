...
from functions.save.save_data_for_businessmodel import save_data
from business_model.process_data_for_businessmodel_above3 import process_data_above3
from business_model.process_data_for_businessmodel_under3 import process_data_under3
from business_model.process_data_for_businessmodel_dloc import process_data_dloc
from business_model.process_data_for_businessmodel_profit_growth_rate_coef import process_data_profit_growth_rate_coef
from business_model.process_data_for_businessmodel_gross_profit_ratio_coef import process_data_gross_profit_ratio_coef
from business_model.process_data_for_businessmodel_cost_ratio_coef import process_data_cost_ratio_coef
from business_model.process_data_for_businessmodel_expense_ratio_coef import process_data_expense_ratio_coef
from business_model.process_data_for_businessmodel_risk_premium_coef import process_data_risk_premium_coef
import CONFIG.globalENV as gl


def business_model(PID, flag, financial_report_data, main_industry):
